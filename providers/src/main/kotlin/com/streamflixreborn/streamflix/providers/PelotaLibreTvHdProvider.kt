...
object PelotaLibreTvHdProvider : IptvProvider {
    ...
    override suspend fun search(query: String, page: Int): List<Item> = emptyList()
        ...
        while (depth < maxDepth) {
            ...
            try {
                ...
                if (pairsMatches.size > 10) {
                    ...
                    if (firstPair != null) {
                        try {
                            val decodedB64 = String(Base64.getDecoder().decode(firstPair.second))
                            ...
                            if (numberOnly != null) {
                                ...
                                for (k in possibleKs) {
                                    ...
                                    for (pair in pairs) {
                                        val d64 = String(Base64.getDecoder().decode(pair.second))
