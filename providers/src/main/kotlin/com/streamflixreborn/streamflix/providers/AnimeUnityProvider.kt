...
object AnimeUnityProvider : Provider {
    ...
    private fun parseLatestAdditions(document: Element): List<Item> {
    ...
    private fun parseFeaturedAnime(document: Element): List<Item> {
        val items = mutableListOf<Item>()
    ...
    private fun parseAnimeFromJson(records: org.json.JSONArray): List<Item> {
    ...
    private suspend fun getAnimeByGenre(genreId: Int, genreName: String, offset: Int = 0): List<Item> {
        return try {
            service.getArchivio()
