...
object CineCityProvider : IptvProvider {
    ...
    private fun getAllChannels(): List<M3UChannel> {
        ...
        return try {
            val decodedUrl = String(Base64.getDecoder().decode(OBFUSCATED_PLAYLIST))
